...
- README по умолчанию: `README.md` (русский), английская версия: `README.en.md`
...
`make install-deps` устанавливает dev-зависимости из `requirements-dev.txt` в user-space и подходит для Homebrew Python на macOS.
